...
<div class="container">
    ...
    <div class="content_layer">
        ...
        <p style="
        text-align: center;"><b>Library Name </b> : {{$record->libraryName}}</p>
         <p style="
        text-align: center;"><b>Library Type</b> : {{$record->libraryType}}</p>
          <p style="
           text-align: center;"><b>Librarian Name</b> : {{$record->librarianName}}</p>
          <p style="
        text-align: center;"><b>Librarian Role </b> :{{$record->role}}</p>
         <p style="
