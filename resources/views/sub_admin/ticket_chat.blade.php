                            ...
                            <div class="chat-header clearfix d-flex">
                                @foreach($data as $value)
                                    @if($value->status=='2')  
                                        ...
                                        @if($value->image == null)
                                        <img src="{{ asset("images/default.png") }}" alt="" class="rounded-image">
                                                        
                                                    @elseif($val->ticketType == 'publisher')
                                                    <img src="{{ asset("publisher/images/profile/".$value->image) }}" alt="" class="rounded-image">
                                        
                                                    @elseif($val->ticketType == 'distributor')
                                                    <img src="{{ asset("distributor/images/profile/".$value->image) }}" alt="" class="rounded-image">
                                                     
                                                    @else
                                                    <img src="{{ asset("publisher_and_distributor/images/profile/".$value->image) }}" alt="" class="rounded-image">
                                                       
                                                    @endif
                                          
                                        </div>
                                        <div class="chat-about">
                                            <div class="chat-with">Chat with {{$value->firstname}}  {{$value->lastname}}</div>
