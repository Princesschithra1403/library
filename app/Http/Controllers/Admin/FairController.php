...
class FairController extends Controller
{
    public function district(){
        ...
        return view('admin/fair_manage_add')->with('district',$district);   
    }
    ...
    public function fairmanagelist(){
      ...
      if($eventdata1 !== null){
       ...
       $events = Events::orderBy('created_at', 'desc')->get();
        return view('admin/fair_manage_list')->with('events',$events);   
   }
    ...
    public function fairmanageprevious(){
      ...
      foreach($event as $key=>$val){
       ...
       $events = Events::where('status', '0')->orderBy('created_at', 'desc')->get();
        return view('admin/fair_manage_previous')->with('events',$events);   
   }
   public function fairmanagecurrent(){
    ...
    foreach($event as $key=>$val){
     ...
     $events = Events::where('status', '1')->orderBy('created_at', 'desc')->get();
      return view('admin/fair_manage_current')->with('events',$events);   
 }
 public function fairmanageupcomming(){
  ...
  foreach($event as $key=>$val){
   ...
   $events = Events::where('status', '2')->orderBy('created_at', 'desc')->get();
    return view('admin/fair_manage_upcomming')->with('events',$events);   
}
    public function fairmanageview($id){
        $event = Events::find($id);
      
        return redirect('admin/fair_manage_view')->with('event',$event);   
    }
    ...
    public function fairmanageedit($id){
      ...
      return redirect('admin/fair_manage_edit')->with('event',$event);   
  }
  ...
  public function aplicationfairlist(){
    ...
    return view('admin.aplication_fair_list')->with('event',$event);  
}
...
public function aplicationfairview($id){
  $apply=ApplicationApply::where('event_id', '=',  $id)
    ->get();
      ...
      return redirect('admin/aplication_fairview')->with('apply',$apply);   
