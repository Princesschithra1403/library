...
class TicketController extends Controller
{
    public function ticketlist(){
          $loginid=auth('publisher')->user()->id;
         ...
         return view('publisher.ticket_list')->with('data',$data);   
     }
     ...
     public function ticketcompleted(){
        ...
        $ticket= Ticket::where('userId',$loginid)->where('user',"1")->where('status',"0")->get();
         ...
         return view('publisher.ticket_completed')->with('data',$data);   
     }
     public function ticketpending(){
        ...
        $ticket= Ticket::where('userId',$loginid)->where('user',"1")->where('status',"1")->get();
         ...
         return view('publisher.ticket_pending')->with('data',$data);   
     }
     ...
     public function ticketview($id){
       $ticket = Ticket::find($id);
        ...
        return redirect('publisher/ticket_view')->with('ticket',$ticket);   
    }
     
     public function districtlist(){
         $district = District::all();
         return view('publisher.ticket_create')->with('district',$district);   
     }
     ...
     public function getdistric($district){
         ...
         if($districts !=null){
            ...
            return redirect('publisher/ticket_chat')->with('ticdata',$ticdata);
