...
class TicketController extends Controller
{
    public function ticketlist(){
        ...
        $ticket= Ticket::where('userId',$loginid)->where('user',"1")->get();
         ...
         return view('publisher_and_distributor.ticket_list')->with('data',$data);   
     }
     ...
     public function ticketcompleted(){
        $loginid=auth('publisher_distributor')->user()->id;
         ...
         return view('publisher_and_distributor.ticket_completed')->with('data',$data);   
     }
     public function ticketpending(){
        $loginid=auth('publisher_distributor')->user()->id;
         ...
         return view('publisher_and_distributor.ticket_pending')->with('data',$data);   
     }
     ...
     public function ticketview($id){
       $ticket = Ticket::find($id);
        ...
        return redirect('publisher_and_distributor/ticket_view')->with('ticket',$ticket);   
    }
     
     public function districtlist(){
         $district = District::all();
         return view('publisher_and_distributor.ticket_create')->with('district',$district);   
     }
     ...
     public function getdistric($district){
         ...
         if($districts !=null){
             ...
             $data= [
              ...
              public function  ticketadd(Request $req){
                ...
                if($subadmin !=null){
                 ...
                 $ticket->ticketType = "publisherdistributor";
                 if($ticket->save()){
            ...
            return redirect('publisher_and_distributor/ticket_chat')->with('ticdata',$ticdata);
